...
#./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/ft.temporal.krovetz -topics topics/topics.ft.301-400.krovetz.indri -qrels qrels/qrels.ft.301-400 -metric ap  > best/ql.ft.map.out
#./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/ft.temporal.krovetz -topics topics/topics.ft.301-400.krovetz.indri -qrels qrels/qrels.ft.301-400 -metric ndcg > best/ql.ft.ndcg.out
#./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/ft.temporal.krovetz -topics topics/topics.ft.301-400.krovetz.indri -qrels qrels/qrels.ft.301-400 -metric p_20 > best/ql.ft.p20.out

./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/latimes.temporal.krovetz -topics topics/topics.latimes.301-400.krovetz.indri -qrels qrels/qrels.latimes.301-400 -metric ap -mu 500 > best/ql.mu=500.latimes.map.out
./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/latimes.temporal.krovetz -topics topics/topics.latimes.301-400.krovetz.indri -qrels qrels/qrels.latimes.301-400 -metric ndcg -mu 500 > best/ql.mu=500.latimes.ndcg.out
./run.sh edu.gslis.main.GetBestQLWeights -index /data0/willis8/indexes/latimes.temporal.krovetz -topics topics/topics.latimes.301-400.krovetz.indri -qrels qrels/qrels.latimes.301-400 -metric p_20 -mu 500 > best/ql.mu=500.latimes.p20.out
